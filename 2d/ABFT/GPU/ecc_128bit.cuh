#ifndef ECC_128BIT_CUH
#define ECC_128BIT_CUH
...
__device__ static uint8_t secded128_syndrome_table_int_wide[128] =
{
...
__device__ static uint8_t secded128_syndrome_table_double_wide[128] =
{
  0x01, 0x02, 0x04, 0x08, 0x21, 0x41, 0x81, 0x06,
  0x0A, 0x12, 0x22, 0x42, 0x82, 0x0C, 0x14, 0x24,
  0x44, 0x84, 0x18, 0x28, 0x48, 0x88, 0x30, 0x50,
  0x90, 0x60, 0xA0, 0xC0, 0x63, 0xE1, 0x1D, 0x1B,
  0x17, 0x99, 0x95, 0x93, 0x59, 0x66, 0xE8, 0xE4,
  0xE2, 0x6C, 0x6A, 0x33, 0xB1, 0x96, 0x5C, 0x5A,
  0x56, 0xD8, 0xD4, 0x0F, 0x07, 0x0B, 0x13, 0x23,
  0x43, 0x83, 0x0D, 0x15, 0x25, 0x45, 0x85, 0x19,
  0x10, 0x20, 0x40, 0x80, 0x51, 0x91, 0x61, 0xA1,
  0xC1, 0x0E, 0x16, 0x26, 0x46, 0x86, 0x1A, 0x2A,
  0x4A, 0x8A, 0x32, 0x52, 0x92, 0x62, 0xA2, 0xC2,
  0x1C, 0x2C, 0x4C, 0x8C, 0x34, 0x54, 0x94, 0x64,
  0xA4, 0xC4, 0x38, 0x58, 0x98, 0x68, 0xA8, 0xC8,
...
__device__ static inline int32_t get_fliped_bit_location_int_wide_128bit(uint32_t syndrome)
{
...
__device__ static inline int32_t get_fliped_bit_location_double_wide_128bit(uint32_t syndrome)
{
  for(uint32_t i = 0; i < 128; i++)
  {
    if(syndrome == secded128_syndrome_table_double_wide[i])
    {
      return i;
    }
  }
