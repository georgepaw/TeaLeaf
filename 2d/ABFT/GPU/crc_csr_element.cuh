...
__device__ static inline uint8_t check_crc32c_csr_elements(uint32_t * cols_out, double * vals_out, uint32_t * cols_in, double * vals_in, const uint32_t num_elements, uint32_t * flag)
{
  uint32_t prev_crc = 0;
...
__device__ static inline void add_crc32c_csr_elements(uint32_t * cols_out, double * vals_out, const uint32_t * cols_in, const double * vals_in, const uint32_t num_elements)
{
  for(int i = 0; i < num_elements; i++)
  {
