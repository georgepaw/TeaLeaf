...
__global__ void cg_init_csr(
        const int x_inner, const int y_inner, const int halo_depth,
        const double* kx, const double* ky, uint32_t* row_index,
...
__global__ void cheby_init(
        ...
        double* r, double* w, uint32_t* row_index, uint32_t* col_index, double* non_zeros);
...
__global__ void cheby_calc_p(
        ...
        double* w, uint32_t* row_index, uint32_t* col_index, double* non_zeros);
...
__global__ void ppcg_calc_ur(
        ...
        double* u, double* r, uint32_t* row_index, uint32_t* col_index, double* non_zeros);
